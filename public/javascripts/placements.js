$(document).ready(function(){
	...
	$("#getdata").click(function(){
		...
		$.post('/getdetails',{aec:aec,acet:acet,acoe:acoe,cse:cse,agri:agri,min:min,it:it,ece:ece,eee:eee,mca:mca,civil:civil,pt:pt,me:me,ssc:ssc,salary:salary,inter:inter,diploma:diploma,btech:btech,backlogs:backlogs,male:male,female:female}).done(function(data,textStatus,jqXHR){	
		//    alert(data);
		...
		//	alert(data.length);
            ...
            var consoletable = $('#dataTables2-example').DataTable();
		...
		//getting data from server
		$.post('/getdetails',{aec:aec,acet:acet,acoe:acoe,cse:cse,it:it,ece:ece,agri:agri,min:min,eee:eee,mca:mca,civil:civil,pt:pt,me:me,ssc:ssc,inter:inter,diploma:diploma,btech:btech,backlogs:backlogs,male:male,female:female}).done(function(data,textStatus,jqXHR){	
		//    alert(data);
			var jsondata=JSON.stringify(data);
		//	alert(jsondata);
